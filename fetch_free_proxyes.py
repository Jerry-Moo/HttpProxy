...
def get_html(url):
    ...
    request.add_header('User-Agent', 'Mozilla/5.0 (Windows NT 6.3; rv:36.0) Gecko/20100101 Firefox/36.04')
...
def fetch_mimvp():
    """从http://proxy.mimvp.com/free.php抓取免费代理"""
    proxyes = []
    try:
...
def fetch_xici():
    """从http://www.xicidaili.com/nn/抓取免费代理"""
    proxyes = []
    try:
...
def fetch_httpdaili():
    """从http://www.httpdaili.com/mfdl/抓取免费代理 注：更新比较频繁"""
    proxyes = []
    try:
